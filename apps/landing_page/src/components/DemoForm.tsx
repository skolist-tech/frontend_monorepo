...
const DemoForm = () => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-8">
      <h3 className="text-2xl font-bold text-gray-900 mb-6">Book a Demo</h3>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <input
            ...
            className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#0A1F44] focus:border-transparent ${
        ...
        <div>
          ...
          {fieldErrors.school_name && (
            <p className="mt-1 text-sm text-red-600">{fieldErrors.school_name}</p>
          )}
        </div>
